...
###Call Crawler
os.system("java -classpath C:/Users/kiaka/Onedrive/Desktop/1009FinalFiles/Crawler.jar MainProgram " + str(socialMedia) + " " + combo) #(java -classpath -location- -mainclass-)
###Call Crawler
